// ═══════════════════════════════════════════════════════════
// editor-aco.js — ACO section editor
//
// Extracted from editor-sections.js. Handles editing of the
// Airspace Control Order: header fields, and the ACM list with
// sub-dialog for each ACM's geometry and parameters.
// ═══════════════════════════════════════════════════════════
...
function _renderBoundaryList(container, boundary) {
  ...
  boundary.forEach(function (coord, i) {
    ...
    input.value = coord;
    (function (idx) {
      input.addEventListener('input', function () { boundary[idx] = this.value; });
    })(i);
