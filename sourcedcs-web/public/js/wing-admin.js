...
function openRoleSortModal() {
  ...
  document.getElementById('rsoModalOverlay').style.display = 'flex';
  document.body.style.overflow = 'hidden';
...
function closeRoleSortModal() {
  document.getElementById('rsoModalOverlay').style.display = 'none';
  document.body.style.overflow = '';
}
...
document.getElementById('rsoModalOverlay').addEventListener('click', function (e) {
  if (e.target === this) closeRoleSortModal();
});
